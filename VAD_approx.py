...
file_pathlexicon_embeddings = "/Users/miltonlin/Documents/GitHub/Emotions/emotion-tune/word_VAD_approx/lexicon_embeddings_sample.json"
...
vad_vector = VAD_with_embeddings("Luhan", lexicon_embeddings, vad_lexicon, 5)
print(f"Final VAD vector for 'Luhan': {vad_vector}")